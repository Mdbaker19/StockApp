...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.formLogin()
                ...
                .and()
                .authorizeRequests()
                .antMatchers("/", "/register")// pages you do not need to be logged in to view to the permitAll below ( can specify get and posts to the urls as well )
                .permitAll()

                .and() // pages need to be logged in to visit below
                .authorizeRequests()
                .antMatchers ("/profile", "/trade", "/account")//anything with post / something.. you need to be logged in to visit
                .authenticated();
    }
}